package com.wiredbraincoffee.reward.assertalltimeout;
...
public class RewardByGiftServiceTest {
    ...
    @Test
    @DisplayName("Reward applied with enough points - AssertAll")
    void rewardApplied() {
    ...
    @Test
    @DisplayName("Exception is thrown when invalid product ID - Exception")
